...
public class HelloWorldClient {
  ...
  public static synchronized HelloWorldClient getHelloWorldClient() {
    if (client != null) {
      return client;
    }
    String user = "world";
    ...
    // For the example we use plaintext insecure credentials to avoid needing TLS certificates. To
    // use TLS, use TlsChannelCredentials instead.
    ManagedChannel channel = Grpc.newChannelBuilder(target, InsecureChannelCredentials.create()).proxyDetector(new ProxyDetector() {
