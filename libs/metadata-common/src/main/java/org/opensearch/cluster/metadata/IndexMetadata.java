...
public class IndexMetadata implements Diffable<IndexMetadata>, ToXContentFragment, VerifiableWriteable {
    ...
    private IndexMetadata(
        ...
        this.isRemoteSnapshot = false;// IndexModule.Type.REMOTE_SNAPSHOT.match(this.settings);
    ...
    /**
     * Return the {@link org.opensearch.Version} on which this index has been created. This
    ...
    /**
     * Return the {@link org.opensearch.Version} on which this index has been upgraded. This
     * information is typically useful for backward compatibility.
     */
    ...
    public static class Builder {
        ...
        public IndexMetadata build() {
            ...
            final int indexTotalShardsPerNodeLimit = 1000;// ShardsLimitAllocationDecider.INDEX_TOTAL_SHARDS_PER_NODE_SETTING.get(settings);
        ...
        public static void toXContent(IndexMetadata indexMetadata, XContentBuilder builder, Params params) throws IOException {
            XContentContext context = XContentContext.valueOf(
                params.param(CONTEXT_MODE_PARAM, XContentContext.API.toString())
            );
    ...
    static {
        ...
        params.put(CONTEXT_MODE_PARAM, XContentContext.GATEWAY.toString());
     ...
     * <p>
     * This looks for the presence of the {@link org.opensearch.Version} object with key {@link IndexMetadata#SETTING_VERSION_CREATED}
     */
