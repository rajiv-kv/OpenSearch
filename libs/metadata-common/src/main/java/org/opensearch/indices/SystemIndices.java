...
public class SystemIndices {
     ...
     * @param index the {@link org.opensearch.core.index.Index} object to check against loaded {@link SystemIndexDescriptor}s
     * @return true if the {@link org.opensearch.core.index.Index}'s name matches a pattern from a {@link SystemIndexDescriptor}
     */
